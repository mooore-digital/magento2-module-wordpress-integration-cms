define([ ], function(KadenceAccordion) {
    "use strict";
    ...
    (function (global, factory) {
      (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.KadenceAccordion = factory();
    })(void 0, function () {
      'use strict';
            ...
            if (animationAction !== undefined && headerIndex !== undefined) {
              if (animationAction === 'closed') {
                ...
                if (!panelToClose.classList.contains(this.settings.hiddenClass)) {
                  ...
                  panelToClose.style.height = panelToClose.scrollHeight + 'px'; //reflow
                ...
                if (!panelToOpen.classList.contains(this.settings.activeClass)) {
                  ...
                  panelToOpen.style.height = panelToOpen.scrollHeight < parseInt(panelToOpen.getAttribute('data-panel-height')) ? parseInt(panelToOpen.getAttribute('data-panel-height')) + 'px' : panelToOpen.scrollHeight + 'px'; //reflow
