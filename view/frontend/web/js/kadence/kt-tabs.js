define(["jquery", "domReady!"], function ($) {
    $(".kt-tabs-wrap").each(function (a) {
        var ktStartTab = $(this)
            .find("> .kt-tabs-title-list .kt-tab-title-active")
            .attr("data-tab");
        ...
        $(this)
            ...
            .each(function (b) {
                ...
                $(this)
                    ...
                    .find(".kt-tabs-content-wrap > .kt-inner-tab-" + tabId)
                    .attr("aria-labelledby", tabName);
            });
        $(this)
            .find(".kt-tabs-content-wrap > .kt-inner-tab-" + ktStartTab)
    ...
    $(".kt-tabs-accordion-title a").click(function (e) {
        ...
        if (
            ...
            $(this)
                .closest(".kt-tabs-wrap")
                .removeClass("kt-active-tab-" + tabId);
            $(this)
                .parent(".kt-tabs-accordion-title")
                .removeClass("kt-tab-title-active")
                .addClass("kt-tab-title-inactive");
        ...
        if (window.location.hash != "") {
            if ($(window.location.hash + ".kt-title-item").length) {
                ...
                $("#" + tabid)
                    ...
                    .removeClass(function (index, className) {
                        return (
                            className.match(/\bkt-active-tab-\S+/g) || []
                        ).join(" ");
                    })
